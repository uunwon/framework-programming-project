...
<html lang="ko">
  ...
  <body id="bo">
  	...
  	<main role="main" class="container">
  		...
  		<h4 id="title">새 글 작성</h4>
  	
  		<hr><br>
  	
  		<form name=form1 action="http://localhost:8080/yunweb/review/write/" method="post">
  		
	  		<div id="third">
	  		
		      <div id='box-left2'>
		      	<img class="rounded" src="../resources/img/write.png" height="440px" alt="book" /><br>
		      </div>
		      ...
		      <div id='box-right2'>
				  ...
				  <div class="form-label-group">
				    ...
				    <input type="text" class="form-control" placeholder="ID"
				    			name="id" value="${review.id}" required autofocus>
				  </div><Br>
			...
			<div style="text-align:right">
				<button class="btn btn-danger" type="submit" name="submit">&nbsp;&nbsp;새글 등록&nbsp;&nbsp;</button>
